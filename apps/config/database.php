...
$db['halo']['db_debug'] = TRUE;
$db['halo']['cache_on'] = FALSE;
$db['halo']['cachedir'] = '';
$db['halo']['char_set'] = 'utf8';
$db['halo']['dbcollat'] = 'utf8_general_ci';
$db['halo']['swap_pre'] = '';
...
$db['sipt']['db_debug'] = TRUE;
$db['sipt']['cache_on'] = FALSE;
$db['sipt']['cachedir'] = '';
$db['sipt']['char_set'] = 'utf8';
$db['sipt']['dbcollat'] = 'utf8_general_ci';
$db['sipt']['swap_pre'] = '';
$db['sipt']['autoinit'] = FALSE;
$db['sipt']['stricton'] = FALSE;
